...
**For this project, local skills live in `./.codex/skills/` and should be discoverable from `AGENTS.md`.**
...
- Project-specific conventions that belong in `AGENTS.md` or project docs
